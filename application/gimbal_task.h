...
#define GIMBAL_MOTOR_SPEED_PID_MAX_OUT 8000.f
#define GIMBAL_MOTOR_SPEED_PID_MAX_IOUT 200.0f

#define GIMBAL_MOTOR_ANGLE_PID_KP 1500.f//1500.0f
#define GIMBAL_MOTOR_ANGLE_PID_KI 0.0f
#define GIMBAL_MOTOR_ANGLE_PID_KD -0.12f

#define GIMBAL_MOTOR_ANGLE_PID_MAX_OUT 70.0f
#define GIMBAL_MOTOR_ANGLE_PID_MAX_IOUT 2.5f

//Yaw轴中值、范围设置
#define MAX_GIMBAL  3680//3650
#define MIN_GIMBAL  2350//2370
#define MIDDLE_GIMBAL  2000

#define MIDDLE_ANGLE 0.79306811			//中值
